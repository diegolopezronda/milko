      ...
      <Card className="col-span-2 ">
        ...
        >
          <FieldGroup className="grid grid-cols-3">
            <Field data-invalid={errors.ph ? "true" : "false"}>
              ...
              />
              {
                errors && errors.temperature &&errors.temperature.message &&
                (<FieldError errors={[{ message: errors.temperature.message }]}/>)
              }
            </Field>
            <Field data-invalid={errors.temperature ? "true" : "false"}>
              ...
              <InputGroup>
                <InputGroupInput
                  ...
                  {...register("temperature", restrictions.temperature)}
                />
            ...
            <Field data-invalid={errors.colour ? "true" : "false"}>
              ...
              </InputGroup>
              {
                ...
                (<FieldError errors={[{ message: errors.colour.message }]}/>)
              }
            </Field>
          </FieldGroup>
          <FieldGroup className="grid grid-cols-4">
            <Field data-invalid={errors.taste ? "true" : "false"}>
              ...
              </Select>
              {
                ...
                (<FieldError errors={[{ message: errors.taste.message }]}/>)
              }
            </Field>
            <Field data-invalid={errors.odor ? "true" : "false"}>
              ...
              </Select>
              {
                ...
                (<FieldError errors={[{ message: errors.odor.message }]}/>)
              }
            </Field>
            <Field data-invalid={errors.fat ? "true" : "false"}>
              ...
              </Select>
              {
                ...
                (<FieldError errors={[{ message: errors.fat.message }]}/>)
              }
            </Field>
            <Field data-invalid={errors.turbidity ? "true" : "false"}>
              ...
              {
                errors && errors.turbidity &&errors.turbidity.message &&
                (<FieldError errors={[{ message: errors.turbidity.message }]}/>)
              }
            </Field>
          </FieldGroup>
        </form>
        ...
        <CardFooter>
          <Field orientation="horizontal">
            <Button type="submit" className="w-full" form="milk-quality-calculator">
              Submit
            </Button>
          </Field>
        </CardFooter>
        ...
        {!formIsVisible && (<>
          ...
          <CardFooter>
            <Field orientation="horizontal">
              <Button type="submit" className="w-full" onClick={toggleFormIsVisible}>
                Back to form
              </Button>
            </Field>
          </CardFooter>
